...
export class SeedingBank1639739063824 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.manager.getRepository(TABLE_NAME.Bank).insert(banks);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.manager.getRepository(TABLE_NAME.Bank).delete({});
    }
}
